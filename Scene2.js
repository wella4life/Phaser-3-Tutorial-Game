class Scene2 extends Phaser.Scene {
  ...
  create() {
    ...
    this.beamSound = this.sound.add("audio_beam", { volume: 0.2 });
  ...
  pickPowerUp(player, powerUp) {
    ...
    gameSettings.maxPowerups--;
  }
  shootBeam() {
    var beam = new Beam(this);
    if (gameSettings.maxPowerups == 1 || gameSettings.maxPowerups == 0) {
      var beamtwo = new Beamtwo(this);
    }
    if (gameSettings.maxPowerups == 0) {
      var beamthree = new Beamthree(this);
    }
    this.beamSound.play();
  }
  movePlayerManager() {
